...
const HeroSection = () => {
  return (
    <section>
      ...
      repeat={Infinity}
    /></h1>
             <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Pectetur. Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta voluptates porro eveniet? Neque architecto repellat magnam dolores sapiente? Autem, magni.l</p>
        <div>
